...
class _ExerciseChartState extends State<ExerciseChart> {
  ...
  List<ChartData> radialChartData = [
    ChartData('포인트', 0, 300, Color.fromRGBO(75, 135, 185, 1),),
    ChartData('소비시간', 0, 90, Color.fromRGBO(192, 108, 132, 1),),
    ChartData('칼로리', 0, 500, Color.fromRGBO(246, 114, 128, 1),),
  ];

  @override
  void initState() {
    radialChartData = [
      ChartData('포인트', widget.dailyCount.toDouble(), 300, Color.fromRGBO(75, 135, 185, 1),),
      ChartData('소비시간', widget.dailyExTime.toDouble(), 90, Color.fromRGBO(192, 108, 132, 1),),
      ChartData('칼로리', widget.dailyKcal.toDouble(), 500, Color.fromRGBO(246, 114, 128, 1),),
    ];
                  ...
                  child: SfCircularChart(
                    ...
                    series: <CircularSeries>[
                      RadialBarSeries<ChartData, String>(
                        ...
                        yValueMapper: (ChartData data, _) => (data.nowValue / data.goal),
                        pointColorMapper: (ChartData data, _) => data.chartColor.withOpacity(0.3),
                      ...
                      CircularChartAnnotation(
                        ...
                        widget: CircleAvatar(
                          backgroundImage: AssetImage(
                            'lib/assets/images/samples/Dog.PNG',
                          ),
                        ),
                      ),
                    ],
